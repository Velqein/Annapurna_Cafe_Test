...
const HerbLeft = () => (
  <svg width="72" height="200" viewBox="0 0 72 200" fill="none">
    <path d="M36 195 C34 165 30 140 32 110 C34 80 33 55 35 30 C36 15 36 8 36 2"
          stroke={C.blue} strokeWidth="1.8" strokeLinecap="round" fill="none"/>
    {[
      ...
      <g key={i}>
        <path d={`M${sx} ${sy} C${cx1} ${cy1} ${cx2} ${cy2} ${ex} ${ey}`}
              stroke={C.blue} strokeWidth="1.5" strokeLinecap="round" fill="none"/>
        <path d={`M${sx} ${sy} C${sx+(cx1-sx)*0.5} ${sy+(cy1-sy)*0.5} ${cx2} ${cy2} ${ex} ${ey}`}
              stroke={C.blue} strokeWidth="1.1" strokeLinecap="round" fill="none" opacity="0.6"/>
      </g>
    ))}
...
const MushroomRight = () => (
  <svg width="90" height="115" viewBox="0 0 90 115" fill="none">
    {/* cap */}
    <path d="M10 55 C14 28 26 10 45 8 C64 10 76 28 80 55 C80 60 76 63 72 62 C62 59 52 57 45 57 C38 57 28 59 18 62 C14 63 10 60 10 55Z"
          stroke={C.blue} strokeWidth="2" strokeLinecap="round" fill="none"/>
    {/* stem */}
    <path d="M33 57 L34 95 C34 98 37 101 41 101 C45 101 47 98 47 95"
          stroke={C.blue} strokeWidth="2" strokeLinecap="round" fill="none"/>
    <path d="M57 57 L56 95 C56 98 53 101 49 101 C45 101 43 98 43 95"
          stroke={C.blue} strokeWidth="2" strokeLinecap="round" fill="none"/>
    {/* collar */}
...
const ChilliLeft = () => (
  <svg width="65" height="130" viewBox="0 0 65 130" fill="none">
    ...
    {/* body chilli 1 */}
    <path d="M28 12 C23 22 20 34 22 48 C24 62 30 74 32 82 C34 88 37 92 39 88 C41 83 38 70 36 56 C34 42 33 30 30 20 C29 16 28 14 28 12Z"
          stroke={C.blue} strokeWidth="1.8" fill="none"/>
    {/* vein chilli 1 */}
    <path d="M27 30 C23 30 20 34 22 38" stroke={C.blue} strokeWidth="1.2" strokeLinecap="round" fill="none"/>
    {/* body chilli 2 */}
    <path d="M42 10 C38 20 37 32 40 46 C43 60 48 72 46 80 C44 86 47 90 50 86 C53 80 50 66 47 52 C44 38 43 26 43 14 C43 12 42 10 42 10Z"
          stroke={C.blue} strokeWidth="1.8" fill="none"/>
    {/* vein chilli 2 */}
...
const HerbRight = () => (
  <svg width="52" height="185" viewBox="0 0 52 185" fill="none">
    <path d="M26 180 C26 155 24 130 26 105 C28 80 26 55 26 30 C26 15 27 8 26 2"
          stroke={C.blue} strokeWidth="1.8" strokeLinecap="round" fill="none"/>
    {[
      ...
      <g key={i}>
        <path d={`M${sx} ${sy} C${cx1} ${cy1} ${cx2} ${cy2} ${ex} ${ey}`}
              stroke={C.blue} strokeWidth="1.5" strokeLinecap="round" fill="none"/>
        <path d={`M${sx} ${sy} C${sx+(cx1-sx)*0.6} ${sy+(cy1-sy)*0.6} ${ex} ${ey} ${ex} ${ey}`}
              stroke={C.blue} strokeWidth="1" strokeLinecap="round" fill="none" opacity="0.55"/>
      </g>
    ))}
...
/* ─── O Symbol ──────────────────────────────────────────────────────────────── */
const OSymbol = ({ size = 48 }) => (
  <svg width={size} height={size} viewBox="0 0 60 60" fill="none">
    <circle cx="30" cy="30" r="19" stroke={C.orange} strokeWidth="6"
            strokeLinecap="round" strokeDasharray="8 3"/>
  </svg>
);

/* ─── Initial board ─────────────────────────────────────────────────────────── */
const INITIAL_BOARD = ["X","O","X","O","X","O","X","O","X"];

/* ════════════════════════════════════════════════════════════════════════════ */
/*  MAIN COMPONENT                                                              */
/* ════════════════════════════════════════════════════════════════════════════ */
export default function AnnapurnaGame() {
  const [gameMode, setGameMode] = useState("single");
  const [board, setBoard]       = useState(INITIAL_BOARD);
  const [current, setCurrent]   = useState("X");
  const [scores]                = useState({ x: 5, ties: 2, o: 3 });
      ...
      <div style={{ display:"flex", alignItems:"center", justifyContent:"center",
        ...
        <div style={{ position:"relative", width:393, height:852 }}>
          ...
          <div style={{
            ...
            background:"#1a1a1a",
            boxShadow:"0 40px 80px rgba(0,0,0,0.55), inset 0 0 0 1px #333",
            zIndex:20,
            pointerEvents:"none",
          }}/>
          ...
          <div style={{
            ...
            width:120, height:34,
            background:"#0a0a0a",
            borderRadius:20, zIndex:30, pointerEvents:"none",
          }}/>

          {/* side buttons */}
          {[{left:-12,top:108,h:32},{left:-12,top:156,h:56},{left:-12,top:222,h:56}].map((b,i)=>(
            <div key={i} style={{ position:"absolute", left:b.left, top:b.top,
              width:4, height:b.h, background:"#333", borderRadius:2, zIndex:25 }}/>
          ))}
          <div style={{ position:"absolute", right:-12, top:180, width:4, height:72,
            background:"#333", borderRadius:2, zIndex:25 }}/>
          ...
          <div style={{
            ...
            <motion.div
              style={{
                ...
                width:220, height:300, borderRadius:"60% 40% 50% 70%",
                background:C.sage, opacity:0.28, filter:"blur(44px)",
                pointerEvents:"none",
              }}
            ...
            <motion.div
              style={{
                ...
                width:200, height:260, borderRadius:"50% 70% 40% 60%",
                background:C.yellow, opacity:0.30, filter:"blur(38px)",
                pointerEvents:"none",
              }}
            ...
            <div style={{ position:"absolute", left:-4, top:130, opacity:0.30, pointerEvents:"none" }}>
              <HerbLeft />
            </div>
            <div style={{ position:"absolute", right:0, top:110, opacity:0.28, pointerEvents:"none" }}>
              <MushroomRight />
            </div>
            <div style={{ position:"absolute", left:0, bottom:90, opacity:0.28, pointerEvents:"none" }}>
              <ChilliLeft />
            </div>
            <div style={{ position:"absolute", right:2, bottom:60, opacity:0.28, pointerEvents:"none" }}>
              <HerbRight />
            </div>
            ...
            <div style={{
              ...
              <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between",
                ...
                <div style={{ display:"flex", alignItems:"center", gap:5 }}>
                  {/* signal bars */}
                  <svg width="16" height="11" viewBox="0 0 16 11" fill={C.blue}>
                  ...
                  <svg width="15" height="11" viewBox="0 0 15 11" fill="none">
                    <path d="M7.5 9.5a1 1 0 100 2 1 1 0 000-2z" fill={C.blue}/>
                    <path d="M4.5 7.5C5.4 6.6 6.4 6 7.5 6s2.1.6 3 1.5" stroke={C.blue} strokeWidth="1.4" strokeLinecap="round" fill="none"/>
                    <path d="M2 5C3.8 3.2 5.6 2.2 7.5 2.2S11.2 3.2 13 5" stroke={C.blue} strokeWidth="1.4" strokeLinecap="round" fill="none"/>
                    <path d="M0 2.5C2.2.8 4.7 0 7.5 0s5.3.8 7.5 2.5" stroke={C.blue} strokeWidth="1.4" strokeLinecap="round" fill="none"/>
                  </svg>
                  {/* battery */}
              ...
              <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:8 }}>
                ...
                <motion.button
                  style={{
                    ...
                    display:"flex", alignItems:"center", justifyContent:"center",
                    boxShadow:"0 2px 10px rgba(242,207,74,0.40)",
                    flexShrink:0,
                  }}
                  whileHover={{ scale:1.08 }} whileTap={{ scale:0.92 }}
                >
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                    <path d="M8 21h8M12 17v4M5 3h14l-1 8c0 3.3-2.7 6-6 6s-6-2.7-6-6L5 3Z"
              ...
              <div style={{ display:"flex", gap:10, marginBottom:12 }}>
                ...
                >
                  ...
                  <p style={{ fontFamily:"'Bungee',sans-serif", fontSize:9.5, color:C.blue,
                               letterSpacing:"0.06em", marginBottom:2 }}>
                    SINGLE PLAYER
                  </p>
                  <p style={{ fontFamily:"'Poppins',sans-serif", fontSize:9, color:"#5a7a55", marginBottom:8 }}>
                    Play with yourself
                  </p>
                  {/* arrow */}
                  <div style={{
                    width:22, height:22, borderRadius:"50%", background:"#A8D5A2",
                    display:"flex", alignItems:"center", justifyContent:"center",
                  }}>
                    <svg width="10" height="10" viewBox="0 0 24 24" fill="none">
                      <path d="M5 12h14M13 6l6 6-6 6" stroke={C.blue} strokeWidth="2.5"
                ...
                >
                  ...
                  <p style={{ fontFamily:"'Poppins',sans-serif", fontSize:9, color:"#4a6aa0", marginBottom:8 }}>
                    Play with a friend
                  </p>
                  {/* arrow */}
                  <div style={{
                    width:22, height:22, borderRadius:"50%", background:"#BFDBFE",
                    display:"flex", alignItems:"center", justifyContent:"center",
                  }}>
                    <svg width="10" height="10" viewBox="0 0 24 24" fill="none">
                      <path d="M5 12h14M13 6l6 6-6 6" stroke={C.blue} strokeWidth="2.5"
              ...
              <motion.div
                style={{
                  ...
                  padding:"14px 16px",
                  boxShadow:"0 4px 20px rgba(31,69,145,0.07)",
                  marginBottom:10,
                }}
              ...
              >
                <div style={{ display:"flex", alignItems:"center", justifyContent:"space-around" }}>
                  ...
                  <div style={{ display:"flex", flexDirection:"column", alignItems:"center", gap:2 }}>
                    ...
                    <span style={{ fontFamily:"'Poppins',sans-serif", fontSize:8.5, fontWeight:600,
                                   color:"#aaa", letterSpacing:"0.12em" }}>YOU</span>
                    <span style={{ fontFamily:"'Bungee',sans-serif", fontSize:24, color:C.blue }}>
                  ...
                  {/* TIES */}
                  <div style={{ display:"flex", flexDirection:"column", alignItems:"center", gap:2 }}>
                    <span style={{ fontFamily:"'Poppins',sans-serif", fontSize:8.5, fontWeight:700,
                                   color:C.green, letterSpacing:"0.12em" }}>TIES</span>
                    <span style={{ fontFamily:"'Bungee',sans-serif", fontSize:24, color:"#333" }}>
                  ...
                  <div style={{ display:"flex", flexDirection:"column", alignItems:"center", gap:2 }}>
                    ...
                    <span style={{ fontFamily:"'Poppins',sans-serif", fontSize:8.5, fontWeight:600,
                                   color:"#aaa", letterSpacing:"0.12em" }}>OPPONENT</span>
                    <span style={{ fontFamily:"'Bungee',sans-serif", fontSize:24, color:C.orange }}>
              ...
              <div style={{ display:"flex", justifyContent:"center", marginBottom:10 }}>
                <motion.div
                  style={{
                    ...
                    paddingLeft:14, paddingRight:18, paddingTop:7, paddingBottom:7,
                    borderRadius:50, background:C.blue,
                    boxShadow:"0 4px 14px rgba(31,69,145,0.30)",
                  }}
              ...
              <motion.div
                style={{
                  ...
                  padding:16,
                  boxShadow:"0 8px 32px rgba(31,69,145,0.09)",
                  marginBottom:12,
                }}
                ...
                <div style={{ display:"grid", gridTemplateColumns:"repeat(3,1fr)", position:"relative" }}>
                  ...
                  <div style={{ position:"absolute", inset:0, pointerEvents:"none" }}>
                    ...
                    <div style={{ position:"absolute", top:0, bottom:0,
                                  left:"33.33%", width:1.5, background:C.blue, opacity:0.13 }}/>
                    <div style={{ position:"absolute", top:0, bottom:0,
                                  left:"66.66%", width:1.5, background:C.blue, opacity:0.13 }}/>
                    {/* horizontal */}
                    <div style={{ position:"absolute", left:0, right:0,
                                  top:"33.33%", height:1.5, background:C.blue, opacity:0.13 }}/>
                    <div style={{ position:"absolute", left:0, right:0,
                                  top:"66.66%", height:1.5, background:C.blue, opacity:0.13 }}/>
                  </div>
                  ...
                  {board.map((cell, i) => (
                    <motion.div
                      ...
                      whileHover={!cell ? { scale:1.06 } : {}}
                      whileTap={!cell ? { scale:0.94 } : {}}
                    >
              ...
              >
                ...
                <span style={{
                  fontFamily:"'Bungee',sans-serif",
                  fontSize:14, color:C.blue, letterSpacing:"0.09em",
                }}>
                  RESET GAME
                </span>
              </motion.button>
                ...
                <div style={{ display:"flex", alignItems:"center", gap:12 }}>
                  ...
                  <div style={{ flex:1, display:"flex", gap:9, alignItems:"flex-start" }}>
                    ...
                    <div style={{
                      ...
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
                        <path d="M12 2a7 7 0 00-7 7c0 2.6 1.4 4.9 3.5 6.2V17a.5.5 0 00.5.5h6a.5.5 0 00.5-.5v-1.8C17.6 13.9 19 11.6 19 9a7 7 0 00-7-7z"
                              stroke={C.sage} strokeWidth="1.8" strokeLinecap="round"/>
                        <path d="M9 21h6M10 19h4" stroke={C.sage} strokeWidth="1.8" strokeLinecap="round"/>
                      </svg>
                    </div>
                    <div>
                      <p style={{ fontFamily:"'Bungee',sans-serif", fontSize:10, color:C.blue,
                                   letterSpacing:"0.05em", marginBottom:4 }}>
                        Win Rules
                      </p>
                      <p style={{ fontFamily:"'Poppins',sans-serif", fontSize:8.5,
                  ...
                  <div style={{ display:"flex", flexDirection:"column", alignItems:"center", gap:6, minWidth:72 }}>
                    <span style={{ fontFamily:"'Poppins',sans-serif", fontSize:8.5,
                                   fontWeight:600, color:"#aaa", letterSpacing:"0.08em" }}>
                      Current Player
                    </span>
                    <div style={{
                      ...
                      <span style={{ fontFamily:"'Bungee',sans-serif", fontSize:13, color:C.blue }}>X</span>
                      <span style={{ fontFamily:"'Poppins',sans-serif", fontSize:9.5,
                                     fontWeight:700, color:C.blue }}>YOU</span>
                    </div>
                  </div>
                </div>
              </motion.div>
